...
fit <- read_csv("~/PhD/Capita-CATE/HPC/GRFoutput/fit-2000-1.6-1.4-2-1.txt", 
                col_names = FALSE)
...
for (rho in c(0,0.25,0.5,0.75,1)){
    for (n in c(200,2000,20000)){
        ...
        if(n<20000){
            fit  <- data.frame(read_csv(paste("~/PhD/Capita-CATE/HPC/GRFoutput/fit-",n,"-1.6-1.4-2-",rho,".txt",sep=""), 
                                         col_names = FALSE))
        }
        if(n==20000){
            fit  <- data.frame(read_csv(paste("~/PhD/Capita-CATE/HPC/GRFoutput/10fit-",n,"-1.6-1.4-2-",rho,".txt",sep=""), 
                                         col_names = FALSE)) 
        }
...
for (rho in c(0,0.25,0.5,0.75,1)){
    for (n in c(200,2000,20000)){
        ...
        if(n<20000){
            cfit  <- data.frame(read_csv(paste("~/PhD/Capita-CATE/HPC/GRFoutput/CUSTOMfit-",n,"-1.6-1.4-2-",rho,".txt",sep=""), 
                                           col_names = FALSE))
        }
        if(n==20000){
            cfit  <- data.frame(read_csv(paste("~/PhD/Capita-CATE/HPC/GRFoutput/10CUSTOMfit-",n,"-1.6-1.4-2-",rho,".txt",sep=""), 
                                           col_names = FALSE)) 
        }
...
#Fig2
#tikz("D:/Documents/Fig2.tex",width=12,height=20)
par(mfrow = c(5,3),
    oma = c(5,4,0,0) + 0.1,
    mar = c(0,0,1,1) + 0.1)
...
for (rho in c(0,0.25,0.5,0.75,1)){
    for (n in c(200,2000,20000)){
        #n<-20000
        if(n<20000){
            density <- data.frame(read_csv(paste("~/PhD/Capita-CATE/HPC/GRFoutput/DensityEstimate-",n,"-1.6-1.4-2-",rho,".txt",sep=""), 
                                           col_names = FALSE))
        }
        if(n==20000){
            density <- data.frame(read_csv(paste("~/PhD/Capita-CATE/HPC/GRFoutput/DensityEstimate-",n,"-1.6-1.4-2-",rho,".txt",sep=""), 
...
#Fig3
#tikz("D:/Documents/Fig3.tex",width=12,height=20)
par(mfrow = c(5,3),
    oma = c(5,4,0,0) + 0.1,
    mar = c(0,0,1,1) + 0.1)
    ...
    for (rho in c(0,0.25,0.5,0.75,1)){
        ...
        if(n<20000){
            cdensity <- data.frame(read_csv(paste("~/PhD/Capita-CATE/HPC/GRFoutput/CUSTOMDensityEstimate-",n,"-1.6-1.4-2-",rho,".txt",sep=""), 
                                            col_names = FALSE))
        }
        if(n==20000){
            cdensity <- data.frame(read_csv(paste("~/PhD/Capita-CATE/HPC/GRFoutput/CUSTOMDensityEstimate-",n,"-1.6-1.4-2-",rho,".txt",sep=""), 
        ...
        polygon(x=c(rev(ti), ti), y=c(rev(lb), ub), col=clr6c, border=NA)
